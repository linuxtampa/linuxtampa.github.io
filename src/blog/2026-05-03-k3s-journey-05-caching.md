...
*This is Part 5 of the [k3s Journey](/tags/series:k3s-journey) series. [Part 4](/blog/2026-04-26-k3s-journey-04-dev-platform/) covered the self-hosted dev platform.*
...
*Next up: [Part 6 — The AI Stack: Ollama, Open WebUI, and Qdrant](/blog/2026-05-10-k3s-journey-06-ai-stack/), where we run a local LLM inference server and vector database on commodity hardware.*
