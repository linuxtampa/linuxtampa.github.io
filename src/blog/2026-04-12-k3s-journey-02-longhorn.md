...
*Next up: [Part 3 — TLS Everywhere with cert-manager and Traefik](/blog/2026-04-19-k3s-journey-03-tls/), where we get wildcard HTTPS certificates for all cluster services via Let's Encrypt DNS-01 challenges.*
